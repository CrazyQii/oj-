...
public class FileServiceImpl implements FileService {
    ...
    public RestResponseVO uploadImageByMD(MultipartFile multipartFile, String guid, String username) {
        ...
        try {
            ...
            if (!typeArray.contains(type)) {
                ...
                return RestResponseVO.createByErrorEnum(ResponseEnum.FILE_TYPE_ERROR);
            }
            ...
            if (!parentFile.exists()) {
                ...
                if (!parentFile.canWrite()) {
                    ...
                    return RestResponseVO.createByErrorEnum(ResponseEnum.FILE_PERMISSION_ERROR);
                }
            }
    ...
    public RestResponseVO<String> deleteTestcase(Integer problemId) {
        ...
        try {
            ...
            return RestResponseVO.createByErrorEnum(ResponseEnum.FILE_NOT_FOUND_ERROR);
        }
